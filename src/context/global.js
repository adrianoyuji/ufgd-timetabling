  ...
  const [courses, setCourses] = useState([
...

    {
      ...
      subjects: [
        {
          id: "07008717",
          name: "Algoritmos e Estruturas de Dados I".toUpperCase(),
          type: "OBR",
          workload: 72,
          active: true,
          semester: 1,
        ...
        {
          id: "031203120",
          name: "Laboratório de Programação I".toUpperCase(),
          type: "OBR",
          workload: 72,
          active: true,
          semester: 1,
        ...
        {
          id: "07004128717",
          name: "Arquitetura e Organização de Computadores".toUpperCase(),
          type: "OBR",
          workload: 72,
          active: true,
          semester: 3,
        ...
        {
          id: "03120142120",
          name: "Algoritmos e Estruturas de Dados III".toUpperCase(),
          type: "OBR",
          workload: 72,
          active: true,
          semester: 3,
        ...
        {
          id: "031210142120",
          name: "Fundamentos de Sistemas de Informação".toUpperCase(),
          type: "OBR",
          workload: 72,
          active: true,
          semester: 3,
        ...
        {
          id: "032120142120",
          name: "Linguagem de Programação I".toUpperCase(),
          type: "OBR",
          workload: 72,
          active: true,
          semester: 3,
        ...
        {
          id: "1231246567",
          name: "Linguagem de Programação III".toUpperCase(),
          type: "OBR",
          workload: 72,
          active: true,
          semester: 5,
        ...
        {
          id: "18731246567",
          name: "Engenharia de Software I".toUpperCase(),
          type: "OBR",
          workload: 72,
          active: true,
          semester: 5,
        ...
        {
          id: "1246567",
          name: "Banco de Dados II".toUpperCase(),
          type: "OBR",
          workload: 36,
          active: true,
          semester: 5,
        ...
        {
          id: "1246569787",
          name: "Laboratório de Banco de Dados II".toUpperCase(),
          type: "OBR",
          workload: 36,
          active: true,
          semester: 5,
        ...
        {
          id: "1246435897567",
          name: "Introdução à Computação Gráfica".toUpperCase(),
          type: "OBR",
          workload: 36,
          active: true,
          semester: 5,
        ...
        {
          id: "1242389076567",
          name: "Laboratório de Computação Gráfica".toUpperCase(),
          type: "OBR",
          workload: 36,
          active: true,
          semester: 5,
        ...
        {
          id: "124135476567",
          name: "Redes de Computadores".toUpperCase(),
          type: "OBR",
          workload: 36,
          active: true,
          semester: 5,
        ...
        {
          id: "03212012242120",
          name: "Gerência de Redes de Computadores".toUpperCase(),
          type: "OBR",
          workload: 72,
          active: true,
          semester: 7,
        ...
        {
          id: "123124336567",
          name: "Gerência de Projetos".toUpperCase(),
          type: "OBR",
          workload: 72,
          active: true,
          semester: 7,
        ...
        {
          id: "1873155246567",
          name: "Metodologia Científica em Ciência da Computação".toUpperCase(),
          type: "OBR",
          workload: 72,
          active: true,
          semester: 7,
        ...
        {
          id: "06797854",
          name: "Desenvolvimento de Projeto de Sistemas Computacionais II".toUpperCase(),
          type: "OBR",
          workload: 72,
          active: true,
          semester: 7,
